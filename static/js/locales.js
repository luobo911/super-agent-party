...
key3`,
        ...
        'DockerSandboxNotice1': 'Docker安全沙箱模式下，你需要安装docker，并使用`docker pull docker/sandbox-templates:latest`拉取最新的沙箱模板镜像，所有的终端命令将会在安全沙箱内执行',
...
Key3`,
        ...
        'DockerSandboxNotice1': 'In Docker Security Sandbox mode, you need to install Docker and use `docker pull docker/sandbox-templates:latest` to pull the latest sandbox template image. All terminal commands will be executed within the secure sandbox.',
